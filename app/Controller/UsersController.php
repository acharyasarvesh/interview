...
class UsersController extends AppController {
			...
			$this->request->data['User']['username'] = strtolower($this->request->data['User']['first_name'].$this->request->data['User']['last_name'].rand(0,1000));
				...
				$ms.='http://recovid.indiascores.com/interview/users/verify/t:'.$hash.'/n:'.$this->request->data['User']['emailid'].'';
					...
					$Email->template('users_signup_email')
						->emailFormat('html')
						->from(array('zdemychd@gmail.com' => 'Zdemy'))
						->to($this->request->data['User']['email'])
						->subject('Confirm Registration for zdemy')
					...
					//$this->request->data['Userdetail']['country'] = $this->request->data['User']['country'];
					//$this->request->data['Userdetail']['firstname'] = $this->request->data['User']['first_name'];
					//$this->request->data['Userdetail']['lastname'] = $this->request->data['User']['last_name'];
					//$this->One->Two->save($this->request->data);
					//$this->User->Userdetail->save($this->request->data);
					//$this->redirect('/emailconfirmation');
	...
	public function edit() {
		...
		//pr($this->Auth->user('Userdetail.user_id'));
		//exit;
