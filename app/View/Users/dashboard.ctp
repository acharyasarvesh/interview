...
<div class="bora_fakkusoglu_header">
  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="Overview"><div class="container">
      ...
      <div class="row-fluid">
        <div class="span8">
          <div class="overview_left_box">
            ...
            <div class="row-fluid overview_left_text">
              <div class="span8"> <img src="images/list-icon.png">
            ...
            <div class="row-fluid overview_left_text">
              <div class="span8"> <img src="images/candidates.png">
        ...
        <div class="span4">
          ...
          <div class="overview_right_text">
            ...
            <hr>
            <img src="images/other-people.png"><a href="#">Invite your peers to help review
            candidates</a>
            <hr>
          </div>
          <div class="overview_right_text">
